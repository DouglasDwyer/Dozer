...
/// </typeparam>
internal sealed class ImmutableDictionaryFormatter<K, V> : ImmutableCollectionFormatterBase<KeyValuePair<K, V?>, ImmutableDictionary<K, V?>, ImmutableDictionary<K, V?>.Builder> where K : notnull
{
    /// <summary>
